...
namespace AppCore.Features.Pricing.Prices.Queries;
...
public class PriceDto
{
    ...
    public AppCore.Enums.PriceType PriceType { get; set; }
...
public class GetPricesByVariantIdHandler
{
    ...
    public GetPricesByVariantIdHandler(AppDbContext context) => _context = context;
