...
public static class AppSeedData
{
    ...
    private static async Task SeedEnumValuesAsync(AppDbContext context)
    {
    ...
    private static async Task SeedPaymentGatewaysAsync(AppDbContext context)
    {
    ...
    private static async Task SeedDeliveryMethodsAsync(AppDbContext context)
    {
    ...
    private static async Task SeedSiteThemeAsync(AppDbContext context)
    {
    ...
    private static async Task SeedSlidersAsync(AppDbContext context)
    {
