 ...
 */(() => {
  var e = {
      ...
      155: (e, t, a) => {
        ...
        a.r(t), a.d(t, {
          MdsPersianDateTimePicker: () => r,
          MdsPersianDateTimePickerSetting: () => s
        });
        const n = bootstrap;
        class r {
          constructor(e, t) {
            ...
            if (this.guid = "", this.bsPopover = null, this.bsModal = null, this.tempTitleString = "", this.hideYearsBox = (e, t) => {
              ...
              const s = this.getYearsBoxBodyHtml(a, 0),
                o = s.html,
              ...
              const a = Number(e.getAttribute("data-number")),
                n = t.setting;
              ...
              const t = e.target;
              if ("HTML" == t.tagName) return void i.getAll().forEach(e => e.setting.modalMode ? () => {} : e.hide());
          ...
          static d2g(e) {
            ...
            let a = 5 * this.div(this.mod(t, 1461), 4) + 308,
              n = this.div(this.mod(a, 153), 5) + 1,
              r = this.mod(this.div(a, 153), 12) + 1;
            return {
              gy: this.div(t, 1461) - 100100 + this.div(8 - r, 6),
              gm: r,
              gd: n
            };
          }
          ...
          static getDisabledDateObject(e) {
            var t, a;
            let n = this.getLesserDisableBeforeDate(e),
          ...
          getYearsBoxBodyHtml(e, t) {
            ...
            const a = r.getClonedDate(e.selectedDateToShow),
            ...
            for (let t = u; t < g; t++) {
              ...
              let n = r.getDateTimeJson2(r.convertToNumber2(t, l.month, r.getDaysInMonthPersian(t, l.month))),
                d = "",
                u = e.isGregorian ? t.toString() : r.toPersianNumber(t),
                g = r.convertToNumber2(t, l.month, 1),
                h = i.year == t ? 'data-current-year="true"' : "",
                b = l.year == t ? "data-selected-year" : "",
                D = "";
          ...
          getDateTimePickerMonthHtml(e, t, a) {
            let n = r.getClonedDate(e.selectedDateToShow),
              s = r.getClonedDate(n),
          ...
          getDateTimePickerBodyHtml(e) {
            let t = r.getClonedDate(e.selectedDateToShow),
