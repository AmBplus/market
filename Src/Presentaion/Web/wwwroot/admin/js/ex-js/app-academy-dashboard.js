...
(function () {
  ...
  var dt_academy_course = $('.datatables-academy-course'),
    logoObj = {
      angular: '<span class="badge bg-label-danger p-2"><i class="fas fa-brands fa-angular fa-md"></i></span>',
      figma: '<span class="badge bg-label-warning p-2"><i class="fas fa-brands fa-figma fa-md"></i></span>',
      react: '<span class="badge bg-label-info p-2"><i class="fas fa-brands fa-react fa-md"></i></span>',
      art: '<span class="badge bg-label-success p-2"><i class="fas fa-swatchbook fa-md"></i></span>',
      fundamentals: '<span class="badge bg-label-primary p-2"><i class="fas fa-gem fa-md"></i></span>'
    };
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            return (
              ...
              '<i class="fas fa-users fa-sm me-2 text-primary"></i>' +
              $user_number +
              '</div>' +
              '<div class="w-px-50 d-flex align-items-center">' +
              '<i class="fas fa-book fa-sm me-2 text-info"></i>' +
              $note +
              '</div>' +
              '<div class="w-px-50 d-flex align-items-center">' +
              '<i class="fas fa-video fa-sm me-2 text-danger" ></i>' +
              $view +
              '</div>' +
              '</div>'
            );
