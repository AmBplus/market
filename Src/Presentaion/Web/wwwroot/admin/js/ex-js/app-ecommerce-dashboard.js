...
(function () {
  ...
  if (dt_invoice_table.length) {
    var dt_invoice = dt_invoice_table.DataTable({
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            return (
              ...
              '<a href="javascript:;" class="btn btn-sm btn-icon dropdown-toggle hide-arrow" data-bs-toggle="dropdown"><i class="fas fa-ellipsis-vertical fa-sm lh-1"></i></a>' +
      ...
      buttons: [
        {
          text: '<i class="fas fa-plus me-md-2"></i><span class="d-md-inline-block d-none">Create Invoice</span>',
