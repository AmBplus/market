    ...
    dt_permission = dataTablePermissions.DataTable({
      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            return (
              '<span class="text-nowrap"><button class="btn btn-sm btn-icon me-2" data-bs-target="#editPermissionModal" data-bs-toggle="modal" data-bs-dismiss="modal"><i class="fas fa-pen"></i></button>' +
              '<button class="btn btn-sm btn-icon delete-record"><i class="fas fa-trash"></i></button></span>'
            );
          }
        }
      ],
