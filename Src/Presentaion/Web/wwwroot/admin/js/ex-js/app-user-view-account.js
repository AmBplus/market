        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            return (
              ...
              '<a href="javascript:;" class="text-body" data-bs-toggle="tooltip" title="Send Mail"><i class="fas fa-envelope fa-sm me-2"></i></a>' +
              '<a href="/Apps/Invoice/Preview" class="text-body" data-bs-toggle="tooltip" title="Preview"><i class="fas fa-eye mx-2 fa-sm"></i></a>' +
              '<div class="d-inline-block">' +
              '<a href="javascript:;" class="btn btn-sm btn-icon dropdown-toggle hide-arrow text-body" data-bs-toggle="dropdown"><i class="fas fa-ellipsis-vertical"></i></a>' +
      ...
      buttons: [
        {
          ...
          text: '<i class="fas fa-desktop fa-xs me-2"></i>Export',
          buttons: [
            {
              extend: 'print',
            ...
            {
              extend: 'csv',
              text: '<i class="fas fa-file-alt me-2" ></i>Csv',
              className: 'dropdown-item',
              exportOptions: { columns: [1, 2, 3, 4] }
            },
            {
            ...
            {
              extend: 'pdf',
              text: '<i class="fas fa-file-lines me-2"></i>Pdf',
              className: 'dropdown-item',
              exportOptions: { columns: [1, 2, 3, 4] }
            },
            {
