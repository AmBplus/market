...
$(function () {
  ...
  if (dt_dashboard_table.length) {
    var dt_dashboard = dt_dashboard_table.DataTable({
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            var $row_output =
              ...
              '<span class="avatar-initial rounded-circle bg-label-secondary text-body"><i class="fas fa-truck"></i></span>' +
              '</div>' +
              '</div>' +
      ...
      order: [2, 'asc'],
      dom: '<"amb-table table-responsive"t><"row d-flex align-items-center"<"col-sm-12 col-md-6"i><"col-sm-12 col-md-6"p>>',
      displayLength: 5,
      responsive: {
        details: {
