          ...
          render: function (data, type, full, meta) {
            ...
            if ($paymentObj) {
              return (
                ...
                $paymentObj.class +
                '">' +
                '<i class="fas fa-circle fa-tiny me-2"></i>' +
                $paymentObj.title +
                '</h6>'
              );
            }
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            return (
              ...
              $method +
              '"class="me-2" width="16">' +
              '<span><i class="fas fa-ellipsis me-1 mt-n1"></i>' +
              $method_number +
              '</span>' +
              '</div>'
            );
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            return (
              ...
              '<button class="btn btn-sm btn-icon dropdown-toggle hide-arrow" data-bs-toggle="dropdown"><i class="fas fa-ellipsis-vertical"></i></button>' +
