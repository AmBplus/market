...
$(function () {
  ...
  if (dt_category_list_table.length) {
    var dt_category = dt_category_list_table.DataTable({
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            return (
              ...
              '<button class="btn btn-sm btn-icon delete-record me-2"><i class="fas fa-trash"></i></button>' +
      ...
      buttons: [
        {
          text: '<i class="fas fa-plus fa-xs me-0 me-sm-2"></i><span class="d-none d-sm-inline-block">Add Category</span>',
