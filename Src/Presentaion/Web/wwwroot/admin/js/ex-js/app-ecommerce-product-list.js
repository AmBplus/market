        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            var categoryBadgeObj = {
              Household:
                '<span class="avatar-sm rounded-circle d-flex justify-content-center align-items-center bg-label-warning me-2 p-3"><i class="fas fa-home fa-xs"></i></span>',
              Office:
                '<span class="avatar-sm rounded-circle d-flex justify-content-center align-items-center bg-label-info me-2 p-3"><i class="fas fa-briefcase fa-xs"></i></span>',
              Electronics:
                '<span class="avatar-sm rounded-circle d-flex justify-content-center align-items-center bg-label-danger me-2 p-3"><i class="fas fa-mobile fa-xs"></i></span>',
              Shoes:
                '<span class="avatar-sm rounded-circle d-flex justify-content-center align-items-center bg-label-success me-2"><i class="fas fa-shoe-prints fa-xs"></i></span>',
              Accessories:
                '<span class="avatar-sm rounded-circle d-flex justify-content-center align-items-center bg-label-secondary me-2"><i class="fas fa-watch fa-xs"></i></span>',
              Game: '<span class="avatar-sm rounded-circle d-flex justify-content-center align-items-center bg-label-primary me-2"><i class="fas fa-gamepad fa-xs"></i></span>'
            };
            return (
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            return (
              ...
              '<button class="btn btn-sm btn-icon delete-record"><i class="fas fa-trash"></i></button>' +
              '<button class="btn btn-sm btn-icon dropdown-toggle hide-arrow" data-bs-toggle="dropdown"><i class="fas fa-ellipsis-vertical me-2"></i></button>' +
      ...
      buttons: [
        {
          ...
          text: '<i class="fas fa-download me-1 fa-xs"></i>Export',
          buttons: [
            {
              extend: 'print',
            ...
            {
              extend: 'csv',
              text: '<i class="fas fa-file me-2" ></i>Csv',
              className: 'dropdown-item',
              exportOptions: {
                columns: [1, 2, 3, 4, 5, 6, 7],
                format: {
            ...
            {
              extend: 'excel',
              text: '<i class="fas fa-file-export me-2"></i>Excel',
              className: 'dropdown-item',
              exportOptions: {
                columns: [1, 2, 3, 4, 5, 6, 7],
                format: {
            ...
            {
              extend: 'pdf',
              text: '<i class="fas fa-file-alt me-2"></i>Pdf',
              className: 'dropdown-item',
              exportOptions: {
                columns: [1, 2, 3, 4, 5, 6, 7],
                format: {
        ...
        {
          text: '<i class="fas fa-plus me-0 me-sm-1 fa-xs"></i><span class="d-none d-sm-inline-block">Add Product</span>',
