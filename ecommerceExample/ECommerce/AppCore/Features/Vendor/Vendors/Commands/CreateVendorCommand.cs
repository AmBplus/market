...
namespace ECommerce.AppCore.Features.Vendor.Vendors.Commands;
...
public class CreateVendorHandler
{
    ...
    public CreateVendorHandler(ECommerceDbContext context) => _context = context;
    ...
    public async Task<ResultOperation> Handle(CreateVendorCommand command, CancellationToken ct)
    {
        ...
        var vendor = new Domain.Vendor.Vendor
        {
